...
#include <memory>
#include "../../../SendFileClient/sendfile.h"
...
QT_MOC_LITERAL(1, 9, 6), // "connOK"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 12), // "disconnected"
QT_MOC_LITERAL(4, 30, 21), // "curProgressBarPercent"
QT_MOC_LITERAL(5, 52, 7) // "percent"

    },
    "SendFile\0connOK\0\0disconnected\0"
    "curProgressBarPercent\0percent"
};
...
void SendFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->connOK(); break;
        case 1: _t->disconnected(); break;
        case 2: _t->curProgressBarPercent((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::connOK)) {
                *result = 0;
                return;
            }
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::curProgressBarPercent)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void SendFile::curProgressBarPercent(int _t1)
{
